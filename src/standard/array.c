...
DECLARE_MODULE_METHOD(array_int16_to_bytes) {
  ENFORCE_ARG_COUNT(to_list, 1);
  ENFORCE_ARG_TYPE(to_list, 0, IS_PTR);
...
DECLARE_MODULE_METHOD(array_int32_to_bytes) {
  ENFORCE_ARG_COUNT(to_list, 1);
  ENFORCE_ARG_TYPE(to_list, 0, IS_PTR);
...
DECLARE_MODULE_METHOD(array_int64_to_bytes) {
  ENFORCE_ARG_COUNT(to_list, 1);
  ENFORCE_ARG_TYPE(to_list, 0, IS_PTR);
...
DECLARE_MODULE_METHOD(array_uint16_to_bytes) {
  ENFORCE_ARG_COUNT(to_list, 1);
  ENFORCE_ARG_TYPE(to_list, 0, IS_PTR);
...
DECLARE_MODULE_METHOD(array_uint32_to_bytes) {
  ENFORCE_ARG_COUNT(to_list, 1);
  ENFORCE_ARG_TYPE(to_list, 0, IS_PTR);
...
DECLARE_MODULE_METHOD(array_uint64_to_bytes) {
  ENFORCE_ARG_COUNT(to_list, 1);
  ENFORCE_ARG_TYPE(to_list, 0, IS_PTR);
...
CREATE_MODULE_LOADER(array) {
  static b_func_reg module_functions[] = {
      ...
      {"int16_to_bytes", false, GET_MODULE_METHOD(array_int16_to_bytes)},
      ...
      {"int32_to_bytes", false, GET_MODULE_METHOD(array_int32_to_bytes)},
      ...
      {"int64_to_bytes", false, GET_MODULE_METHOD(array_int64_to_bytes)},
      ...
      {"uint16_to_bytes", false, GET_MODULE_METHOD(array_uint16_to_bytes)},
      ...
      {"uint32_to_bytes", false, GET_MODULE_METHOD(array_uint32_to_bytes)},
      ...
      {"uint64_to_bytes", false, GET_MODULE_METHOD(array_uint64_to_bytes)},
